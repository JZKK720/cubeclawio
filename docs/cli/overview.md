...
The CubeClawIO CLI handles instance setup, diagnostics, and control-plane operations.
...
| Flag | Description |
|------|-------------|
| `--data-dir <path>` | Local CubeClawIO data root (isolates from `~/.paperclip`) |
...
```sh
# Set defaults
pnpm cubecloud.io context set --api-base http://localhost:3100 --company-id <id>
