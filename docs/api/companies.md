...
Manage companies within your CubeClawIO instance.
...
Company logo uploads use the normal CubeClawIO attachment size limit.
...
| `logoUrl` | string | Optional CubeClawIO asset content path for the stored logo image |
