...
CubeClawIO exposes a RESTful JSON API for all control plane operations.
...
- Run audit trail: include `X-CubeClawIO-Run-Id` header on all mutating requests during heartbeats
