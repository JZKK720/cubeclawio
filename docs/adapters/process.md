...
- Running a Python script that calls the CubeClawIO API
...
1. CubeClawIO spawns the configured command as a child process
2. Standard CubeClawIO environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the CubeClawIO API and perform work.
