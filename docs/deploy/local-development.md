...
summary: Set up CubeClawIO for local development
---

Run CubeClawIO locally with zero external dependencies.
...
No Docker or external database required. CubeClawIO uses embedded PostgreSQL automatically.
