...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@cubeclawhub/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@cubeclawhub/adapter-utils").TranscriptEntry[];
