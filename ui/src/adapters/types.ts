...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@cubeclawio/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@cubeclawio/adapter-utils").TranscriptEntry[];
