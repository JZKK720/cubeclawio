 ...
 *
 * Plugin bundles are built with `external: ["@cubeclawhub/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@cubeclawhub/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@cubeclawhub/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@cubeclawhub/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@cubeclawhub/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@cubeclawhub/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@cubeclawhub/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
