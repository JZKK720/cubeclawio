 ...
 *
 * Plugin bundles are built with `external: ["@cubeclawio/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@cubeclawio/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@cubeclawio/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@cubeclawio/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@cubeclawio/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@cubeclawio/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@cubeclawio/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
