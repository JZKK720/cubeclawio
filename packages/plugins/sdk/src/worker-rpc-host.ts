 ...
 * import { startWorkerRpcHost } from "@cubeclawio/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@cubeclawio/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
