 ...
 * import { startWorkerRpcHost } from "@cubeclawhub/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@cubeclawhub/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
