...
| **Paperclip CLI** | `cubecloud.io install`, `cubecloud.io publish`, `cubecloud.io cliphub sync` — built into Paperclip |
...
4. Run `cubecloud.io install cliphub:acme/lean-saas-shop`
...
2. Export: `cubecloud.io export --template my-agency`
3. Publish: `cubecloud.io publish cliphub my-agency`
...
3. Install just that agent: `cubecloud.io install cliphub:acme/senior-python-eng --agent`
...
- [ ] `cubecloud.io install cliphub:<publisher>/<slug>` CLI command
...
- [ ] `cubecloud.io cliphub sync` for bulk publishing
