...
import { agents as agentsTable, companies, heartbeatRuns } from "@cubeclawio/db";
...
import { runClaudeLogin } from "@cubeclawio/adapter-claude-local/server";
import {
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@cubeclawio/adapter-opencode-local/server";
