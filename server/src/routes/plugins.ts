...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@cubeclawhub/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@cubeclawhub/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@cubeclawhub/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@cubeclawhub/plugin-hello-world-example",
  ...
  {
    packageName: "@cubeclawhub/plugin-file-browser-example",
  ...
  {
    packageName: "@cubeclawhub/plugin-kitchen-sink-example",
