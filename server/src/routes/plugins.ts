...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@cubeclawio/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@cubeclawio/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@cubeclawio/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@cubeclawio/plugin-hello-world-example",
  ...
  {
    packageName: "@cubeclawio/plugin-file-browser-example",
  ...
  {
    packageName: "@cubeclawio/plugin-kitchen-sink-example",
