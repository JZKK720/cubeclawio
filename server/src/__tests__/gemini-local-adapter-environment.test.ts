...
import { testEnvironment } from "@cubeclawhub/adapter-gemini-local/server";
...
describe("gemini_local environment diagnostics", () => {
  ...
  it.skipIf(process.platform === "win32")("passes model and yolo flags to the hello probe", async () => {
